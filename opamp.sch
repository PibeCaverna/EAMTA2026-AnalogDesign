...
C {ngspice_probe.sym} 1470 -360 0 0 {name=r4}
C {ngspice_probe.sym} 1780 -60 0 0 {name=r6}
C {ngspice_get_value.sym} 1470 -130 0 0 {name=r9 node=i(@M.X1.XM4.msky130_fd_pr__nfet_01v8[id])
descr="I= "}
C {ngspice_get_value.sym} 1910 -130 0 0 {name=r10 node=i(@M.X1.XM6.msky130_fd_pr__nfet_01v8[id])
descr="I= "}
C {ngspice_get_value.sym} 1590 -340 0 0 {name=r11 node=i(@M.X1.XM2.msky130_fd_pr__pfet_01v8_lvt[id])
descr="I= "}
...
descr="I= "}
C {ngspice_get_value.sym} 990 -320 0 0 {name=r14 node=i(@M.X1.XM8.msky130_fd_pr__pfet_01v8[id])
descr="I= "}
C {launcher.sym} 1000 -170 0 0 {name=h1
descr=Annotate 
tclcommand="ngspice::annotate"}
C {ngspice_get_value.sym} 1590 -310 0 0 {name=r16 node=@M.X1.XM2.msky130_fd_pr__pfet_01v8_lvt[gm]
descr="gm= "}
C {ngspice_get_value.sym} 1470 -100 0 0 {name=r18 node=@M.X1.XM4.msky130_fd_pr__nfet_01v8[gm]
descr="gm= "}
C {ngspice_get_value.sym} 1910 -100 0 0 {name=r19 node=@M.X1.XM6.msky130_fd_pr__nfet_01v8[gm]
descr="gm= "}
...
descr="Vgs= "}
C {ngspice_get_value.sym} 1070 -320 0 0 {name=r7 node=v(@M.X1.XM8.msky130_fd_pr__pfet_01v8[vth])
descr="Vth= "}
C {ngspice_get_value.sym} 990 -280 0 0 {name=r23 node=v(@M.X1.XM8.msky130_fd_pr__pfet_01v8[vdsat])
descr="Vdsat= "}
C {ngspice_get_value.sym} 1980 -130 0 0 {name=r24 node=v(@M.X1.XM6.msky130_fd_pr__nfet_01v8[vth])
descr="Vth= "}
C {ngspice_get_value.sym} 1650 -340 0 0 {name=r26 node=v(@M.X1.XM2.msky130_fd_pr__pfet_01v8_lvt[vth])
descr="Vth= "}
C {ngspice_get_expr.sym} 1980 -100 0 0 {name=r27 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM6.msky130_fd_pr__nfet_01v8[gds]\}]]]"
descr="ro= "}
C {ngspice_get_expr.sym} 1970 -340 0 0 {name=r28 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM7.msky130_fd_pr__pfet_01v8[gds]\}]]]"
descr="ro= "}
C {ngspice_get_expr.sym} 1540 -100 0 0 {name=r29 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM4.msky130_fd_pr__nfet_01v8[gds]\}]]]"
descr="ro= "}
C {ngspice_get_expr.sym} 1650 -310 0 0 {name=r30 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM2.msky130_fd_pr__pfet_01v8_lvt[gds]\}]]]"
descr="ro= "}
C {ngspice_get_value.sym} 2040 -100 0 0 {name=r31 node=@M.X1.XM6.msky130_fd_pr__nfet_01v8[cgg]
descr="Cgg= "}
C {ngspice_get_value.sym} 1970 -370 0 0 {name=r33 node=v(@M.X1.XM7.msky130_fd_pr__pfet_01v8[vth])
descr="Vth= "}
C {ngspice_get_value.sym} 1720 -310 0 0 {name=r34 node=@M.X1.XM2.msky130_fd_pr__pfet_01v8_lvt[cgg]
descr="Cgg= "}
C {ngspice_get_value.sym} 1540 -130 0 0 {name=r2 node=v(@M.X1.XM4.msky130_fd_pr__nfet_01v8[vth])
descr="Vth= "}
C {ngspice_get_value.sym} 1890 -340 0 0 {name=r5 node=v(@M.X1.XM7.msky130_fd_pr__pfet_01v8[vdsat])
descr="Vdsat= "}
